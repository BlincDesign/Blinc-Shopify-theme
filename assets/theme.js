 ...
 * page (sticky header, quantity selector, sliders, add-to-cart, the quick
 * view modal, the cart drawer) - so it loads once via layout/theme.liquid
 ...
 * layout/theme.liquid, present on every page). Body content is fetched
 * from sections/cart-drawer.liquid via the Section Rendering API
 * (?section_id=cart-drawer) and swapped in on open/change.
 */
