/**
 * <quick-modal> - a single, shared native <dialog> that opens Quick Add /
 * Quick View for multi-variant products (from product cards - grids, search
 * results, related products, even the cart drawer's upsell block). Any
...
class QuickModal extends HTMLElement {
    connectedCallback() {
        ...
        // Bound once so disconnectedCallback can remove this exact listener -
        // this section can be reloaded in the Theme Editor, which replaces
        // this element outright, and an unremoved document-level listener
        // would otherwise leak a duplicate on every save.
